    ...
    <div className="flex h-16 items-center justify-between border-b border-[#e5e5e5] px-4 dark:border-[#323232]">
      <div className="flex items-center gap-4 overflow-x-auto">
        <div className="flex min-w-fit items-center gap-2">
          <span className="whitespace-nowrap text-sm text-[#86868b] dark:text-[#a1a1a6]">
            Hardware:
          </span>
        ...
        <div className="flex min-w-fit flex-wrap items-center gap-3">
          <label className="flex items-center gap-1.5">
            <input
              type="checkbox"
              className="form-checkbox rounded border-[#e5e5e5] text-blue-500 dark:border-[#424242]"
            />
            <span className="whitespace-nowrap text-sm text-[#86868b] dark:text-[#a1a1a6]">
              FD Mode
            </span>
      ...
      <button
        ...
        className={`focus-ring ml-4 whitespace-nowrap rounded-md px-4 py-1.5 text-sm font-medium ${
          isConnected
